    ...
    <div className="min-h-screen bg-[#e8eaff] text-stone-800 selection:bg-nobel-gold selection:text-white">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#e8eaff]/90 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
        <div className="w-full px-4 md:px-6 flex justify-between items-center">
          <div className="inline-flex items-center gap-2 text-stone-900 text-lg cursor-pointer -ml-1 md:-ml-2 leading-none" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <img
              src={logoSrc}
              alt="Site logo"
              className="block h-[1.5em] w-auto object-contain shrink-0"
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="fixed inset-0 z-40 bg-[#e8eaff] flex flex-col items-center justify-center gap-8 text-xl font-serif animate-fade-in">
            <a href="#introduction" onClick={scrollToSection('introduction')} className="hover:text-nobel-gold transition-colors cursor-pointer uppercase">Introduction</a>
      ...
      <main>
        ...
        {/* The Science: Results */}
        <section className="py-24 bg-[#e8eaff]">
            <div className="container mx-auto px-6">
        ...
        <section id="impact" className="py-24 bg-white border-t border-stone-200">
             <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12">
                <div className="md:col-span-5 relative">
                    <div className="aspect-square bg-[#f0f2ff] rounded-xl overflow-hidden relative border border-stone-200 shadow-inner">
        ...
        {/* Authors */}
        <section id="authors" className="py-24 bg-[#f0f2ff] border-t border-stone-300">
           <div className="container mx-auto px-6">
      ...
      <footer className="bg-stone-900">
        <div className="container mx-auto px-6 flex justify-center items-center pt-16 md:pt-24 lg:pt-32 pb-10 md:pb-14">
          <img
            src={logoSrc}
            alt="Footer logo"
